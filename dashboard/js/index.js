  ...
  return (
    e('form', {className: 'form-inline'},
      ...
      e('div', {className: 'form-group form-check mr-3 mb-2'},
        e(Toggle, {checked: groupByCountry, onChange: onGroupByCountries, text: 'Agrupar por países'})
      ),
      e('div', {className: 'form-group form-check mr-3 mb-2'},
        e(Toggle, {text: 'Escala Logarítmica', onChange: onUseLogScale, checked: useLogScale})
      ),
...
function RegionsTable({
  ...
  return (
    e('div', null,
      ...
      e('small', {className: 'text-muted'}, '* A tabela é rolável')
    )
  );
}
