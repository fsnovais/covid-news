...
while (condition) {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps !== this.props) {
      this.setState({ url: `top-headlines?category=health&country=br&apiKey=${process.env.REACT_APP_API_KEY}` });
  ...
  getArticles(url) {
    ...
    axios
      .get(`/top-headlines?category=health&country=br&apiKey=${apiKey}`)
      .then(res => {
